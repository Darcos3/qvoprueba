            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Tipo de Usuario') }}</label>
                        ...
                        <div class="row mb-0 ">
                            <div class="col-md-6 offset-md-4 d-grid gap-2">
                                ...
                                <a type="submit" class="btn btn-outline-primary btn-block" href="{{ route('login') }}">
                                    {{ __('Quiero regresar e iniciar sesión') }}
                                </a>
                            </div>
                        </div>
                    </form>
